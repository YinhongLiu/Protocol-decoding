...
public:
	...
	void		ClosePort();																//¹Ø±Õ´®¿Ú
	void		WritePort(char* pSendBuf,UINT len);											//Ð´´®¿Ú
	void		ConfigPort();
	void		VirtualPort(BOOL bVirtual);													//ÐéÄâ´®¿Ú
	BOOL		IsOpenUart(void);
public:
	CString		m_strBuad;
	CString		m_strCheck;
	CString		m_strPort;
...
protected:
	...
	static void WriteVirtualChar(CSerialPort* port);
