/*! Time-stamp: <@(#)ColorStatic.cpp   2002-4-16 - 16:27:20   eric>
 *********************************************************************
 *  @file   : ColorStatic.cpp
 *
 *  Project : 702 (All in One)
 *
 *  Package : 
 *
 *  Company : 
 *
 *  Author  : I don't kown                           Date: 2002-4-16
 *
 *  Purpose : Implementation of methods for class CColorStatic,
 *            this class is download from internet, it is useful for
 *            text process, but had not test it.
 *
 *********************************************************************
 * Version History:
 *
 * V 0.10  2002-4-16  eric: First Revision
 *
 *********************************************************************
 */
